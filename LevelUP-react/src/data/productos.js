...
export const productos = [
  ...
  { 
    codigo: "JDM002", 
    img: '/Carcassonne.png', // Ruta corregida
    nombre: 'Carcassonne', 
    categoria: 'Juegos de Mesa', 
    precio: 24990 
  },
  { 
    codigo: "ACC001", 
    img: '/Controlador Xbox Series X.png', // Ruta corregida
  ...
  { 
    codigo: "ACC002", 
    img: '/Auriculares HyperX Cloud II2.png', // Ruta corregida
  ...
  { 
    codigo: "CON001", 
    img: '/PlayStation 5.webp', // Ruta corregida
  ...
  { 
    codigo: "PCG001", 
    img: '/PC Gamer ASUS ROG Strix.png', // Ruta corregida
  ...
  { 
    codigo: "SIL001", 
    img: '/Silla Gamer Secretlab Titan.webp', // Ruta corregida
  ...
  { 
    codigo: "MOU001", 
    img: '/Mouse Logitech G502 HERO.png', // Ruta corregida
